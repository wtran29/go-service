...
// ParseRole parses the string value and returns a role if one exists. It is the validation function.
...
// an error occurs the function panics. Use only in test code.
